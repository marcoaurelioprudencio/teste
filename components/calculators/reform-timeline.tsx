          ...
          {timelineEvents.map((event, index) => (
            ...
            >
              {index !== timelineEvents.length - 1 && (
                <div className="absolute left-6 top-14 bottom-0 w-0.5 bg-gradient-to-b from-[#FF7A00] to-[#0046B3]" />
              )}
                  ...
                  <div
                    className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      event.status === "current"
                        ? "bg-gradient-to-br from-[#FF7A00] to-[#FF9500] shadow-lg shadow-orange-200"
